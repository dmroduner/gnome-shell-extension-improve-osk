...
function enable() {
    ...
    Keyboard.Keyboard.prototype['_getDefaultKeysForRow'] = function(row, numRows, level) {
        ...
        let defaultKeysPreMod = [
            [ [{ label: 'Esc', width: 1.5, keyval: Clutter.KEY_Escape }], [{ label: '↹', width: 1.5, keyval: Clutter.KEY_Tab }], [{ width: 2, level: 1, extraClassName: 'shift-key-lowercase' }], [{ label: 'Ctrl', width: 1, keyval: Clutter.KEY_Control_L, extraClassName: 'control-key' }, { label: '◆', width: 1, keyval: Clutter.KEY_Super_L, extraClassName: 'super-key' }, { label: 'Alt', width: 1, keyval: Clutter.KEY_Alt_L, extraClassName: 'alt-key' }] ],
            [ [{ label: 'Esc', width: 1.5, keyval: Clutter.KEY_Escape }], [{ label: '↹', width: 1.5, keyval: Clutter.KEY_Tab }], [{ width: 2, level: 0, extraClassName: 'shift-key-uppercase' }], [{ label: 'Ctrl', width: 1, keyval: Clutter.KEY_Control_L, extraClassName: 'control-key' }, { label: '◆', width: 1, keyval: Clutter.KEY_Super_L, extraClassName: 'super-key' }, { label: 'Alt', width: 1, keyval: Clutter.KEY_Alt_L, extraClassName: 'alt-key' }] ],
            [ [{ label: 'Esc', width: 1.5, keyval: Clutter.KEY_Escape }], [{ label: '↹', width: 1.5, keyval: Clutter.KEY_Tab }], [{ label: '=/<F', width: 2, level: 3}], [{ label: 'Ctrl', width: 1, keyval: Clutter.KEY_Control_L, extraClassName: 'control-key' }, { label: '◆', width: 1, keyval: Clutter.KEY_Super_L, extraClassName: 'super-key' }, { label: 'Alt', width: 1, keyval: Clutter.KEY_Alt_L, extraClassName: 'alt-key' }] ],
            [ [{ label: 'Esc', width: 1, keyval: Clutter.KEY_Escape }], [{ label: '↹', width: 1, keyval: Clutter.KEY_Tab }], [{ label: '?123', width: 1.5, level: 2 }], [{ label: 'Ctrl', width: 1, keyval: Clutter.KEY_Control_L, extraClassName: 'control-key' }, { label: '◆', width: 1, keyval: Clutter.KEY_Super_L, extraClassName: 'super-key' }, { label: 'Alt', width: 1, keyval: Clutter.KEY_Alt_L, extraClassName: 'alt-key' }] ],
        ];

    
        let defaultKeysPostMod = [
            [ [{ label: '⌫', width: 2, keyval: Clutter.KEY_BackSpace }, { label: '☻', width: 1.5, action: 'emoji' }],
              [{ width: 2, keyval: Clutter.KEY_Return, extraClassName: 'enter-key' }, { width: 1.5, action: 'languageMenu', extraClassName: 'layout-key' }],
              [{ width: 1.5, level: 1, right: true, extraClassName: 'shift-key-lowercase' }, { label: '↑', width: 1, keyval: Clutter.KEY_Up }, { label: '?123', width: 1.5, level: 2 }],
              [{ label: '←', width: 1, keyval: Clutter.KEY_Left }, { label: '↓', width: 1, keyval: Clutter.KEY_Down }, { label: '→', width: 1, keyval: Clutter.KEY_Right }, { width: 1, action: 'hide', extraClassName: 'hide-key' }] ],
            [ [{ label: '⌫', width: 2, keyval: Clutter.KEY_BackSpace }, { label: '☻', width: 1.5, action: 'emoji' }],
              [{ width: 2, keyval: Clutter.KEY_Return, extraClassName: 'enter-key' }, { width: 1.5, action: 'languageMenu', extraClassName: 'layout-key' }],
              [{ width: 1.5, level: 0, right: true, extraClassName: 'shift-key-uppercase' }, { label: '↑', width: 1, keyval: Clutter.KEY_Up }, { label: '?123', width: 1.5, level: 2 }],
              [{ label: '←', width: 1, keyval: Clutter.KEY_Left }, { label: '↓', width: 1, keyval: Clutter.KEY_Down }, { label: '→', width: 1, keyval: Clutter.KEY_Right }, { width: 1, action: 'hide', extraClassName: 'hide-key' }] ],
            [ [{ label: '⌫', width: 2, keyval: Clutter.KEY_BackSpace }, { label: '☻', width: 1.5, action: 'emoji' }],
              [{ width: 2, keyval: Clutter.KEY_Return, extraClassName: 'enter-key' }, { width: 1.5, action: 'languageMenu', extraClassName: 'layout-key' }],
              [{ label: '=/<F', width: 1.5, level: 3, right: true }, { label: '↑', width: 1, keyval: Clutter.KEY_Up }, { label: 'ABC', width: 1.5, level: 0 }],
              [{ label: '←', width: 1, keyval: Clutter.KEY_Left }, { label: '↓', width: 1, keyval: Clutter.KEY_Down }, { label: '→', width: 1, keyval: Clutter.KEY_Right }, { width: 1, action: 'hide', extraClassName: 'hide-key' }] ],
            [ [{ label: 'F1', width: 1, keyval: Clutter.KEY_F1 }, { label: 'F2', width: 1, keyval: Clutter.KEY_F2 }, { label: 'F3', width: 1, keyval: Clutter.KEY_F3 }, { label: '⌫', width: 1.5, keyval: Clutter.KEY_BackSpace }, { width: 1, action: 'hide', extraClassName: 'hide-key' }],
